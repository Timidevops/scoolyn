...
<main>
    <table style="width: 100%; border-collapse: collapse;">
        ...
        <tr>
            <td style="width: 50%;">
                <h2 style="text-align: left;">KodeDict Academy</h2>
                <p style="text-align: left;">Block 24, House 19, Ibadan Oyo. P.O Box 1402 Dugbe.</p>
                <p style="text-align: left;"><a href="mailto:school@kodedictacademy.com">school@kodedictacademy.com</a></p>
                <p style="text-align: left;">+234(0) 123 456 1234.</p>
                <p style="text-align: left;"><a href="http://www.kodedictacademy.com">www.kodedictacademy.com</a></p>
            </td>
            <td style="width: 50%;">
                <div>
                    <table style="height: 72px; width: 80%; border-collapse: collapse; margin-top: 50px; margin-left: auto; margin-right: auto;" cellspacing="5" cellpadding="5">
                        ...
                        <tr style="height: 18px;">
                            <td style="width: 100%; height: 18px; text-align: left; padding-left: 40px; text-transform: capitalize">
                                <strong>{{$feeDetails->student->first_name}}</strong>
                                <span>{{$feeDetails->student->other_name}}</span>
                                <span>{{$feeDetails->student->last_name}}</span>
                            </td>
                        </tr>
                        <tr style="height: 18px;">
                            <td style="width: 100%; height: 18px; text-align: left; padding-left: 40px;">
                                <span>{{$feeDetails->student->matriculation_number}}</span>
                            </td>
                        </tr>
                        <tr style="height: 18px;">
                            <td style="width: 100%; height: 18px; text-align: left; padding-left: 40px; text-transform: capitalize">
                                <span>{{$feeDetails->status}}</span>
                            </td>
                        </tr>
                        <tr style="height: 18px;">
                            <td style="width: 100%; height: 18px; text-align: left; padding-left: 40px;">
    ...
    <p style="text-align: center; text-transform: capitalize;">
        <strong>
            <span>{{$feeDetails->academicTerm->term_name}} term</span>
            <span>{{str_replace('-','/', $feeDetails->academicSession->session_name)}}</span>
            Academic Session
        </strong>
    </p>
    <p>&nbsp;</p>
    ...
    <table style="width: 100%; border-collapse: collapse;">
        ...
        <tr>
            <td style="width: 50%;">
                ...
                <p><span style="text-decoration: underline;">James doe</span></p>
