...
<main>
    ...
    <p style="text-align: center;">KodeDict Academy, Nigeria</p>
    ...
    <table style="border-collapse: collapse; width: 100%;" border="1">
        ...
        <tr style="background-color: #eceff3; font-size: 10px;">
            ...
            <th style="width: 24%; text-align: center;">SUBJECT</th>
        ...
        <tr>
            ...
            <td style="width: 24%; padding-left: 2px; text-transform: uppercase; font-size: 13px">{{$subject['subjectName']}}</td>
            @foreach($result['ca_format'] as $caFormat)
