            ...
            <div class="flex flex-col mt-2">
                <div class="align-middle min-w-full overflow-x-auto  overflow-hidden ">
                    ...
                    <img src="{{asset('images/filter_alt_black_24dp.svg')}}" alt="" class="w-4">
                        ...
                        <template x-for="(content, index) in filteredFeesTable" :key="index">
                            <tr class="bg-white">
                                ...
                                <td class="max-w-0  px-6 py-4 whitespace-nowrap text-xs text-gray-900">
                                    <div class="flex">
                                        <p class="group inline-flex space-x-2 truncate">
                                            <span class="text-gray-500 truncate capitalize" x-text="content.name"></span>
                                            <span class="text-gray-500 truncate capitalize" x-text="content.total_items"></span>
                                        </p>
                                    </div>
                                </td>
                                <td class="max-w-0  px-6 py-4 whitespace-nowrap text-xs text-gray-900">
                                    <div class="flex">
                                        <p class="group inline-flex space-x-2 truncate">
                                            <span class="text-gray-500 truncate capitalize text-right" x-text="content.amount"></span>
                                        </p>
                                    </div>
                                </td>
                                <td class="max-w-0  px-6 py-4 whitespace-nowrap text-xs text-gray-900">
                                    <div class="flex">
                                        <p class="group inline-flex space-x-2 truncate">
                                            <span class="text-gray-500 truncate capitalize" x-text="content.academic_session.session_name ?? '...'"></span>
                                        </p>
                                    </div>
                                </td>
                                <td class="md:px-6 py-4 text-left whitespace-nowrap text-sm text-gray-200 flex items-center">
                                    <a :href="`{{route('editFeeStructure','')}}/${content.uuid}`" class="focus:outline-none">
