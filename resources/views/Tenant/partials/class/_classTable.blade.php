<div class="mt-8">
  <div class=" sm:block">
            ...
            <tr class="bg-white">
              ...
              <td class="px-6 py-4 text-left whitespace-nowrap text-xs text-gray-200">
                ...
                <td class="md:px-6 py-4 text-left whitespace-nowrap text-sm text-gray-200 flex items-center">
                    <a x-bind:href="`{{route('listClassSubject', '')}}/${item.slug}`">
                  ...
                  <button class="focus:outline-none ">
                    <a x-bind:href="`{{route('classTeacher','')}}/${item.slug}`">
    ...
    <nav class="max-w-6xl  mx-auto px-4 lg:px-8 my-4 py-2  bg-white  md:flex md:items-center md:justify-between border-lighter-gray sm:px-6">
        ...
        {{-- edit modal --}}
        <div class="overflow-auto" style="background-color:rgba(190,192,201,0.7); display:none" x-show="editModal" :class="{ 'absolute inset-0 z-10 flex items-center justify-center': editModal }">
