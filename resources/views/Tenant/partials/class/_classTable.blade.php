        ...
        <div class="mt-12 sm:mx-auto sm:w-full sm:max-w-md md:max-w-md  bg-white rounded-lg shadow-md">
          ...
          <div class="mt-6">
            ...
            <div class="my-6">
              <label for="service" class="block text-xs font-normal text-gray-100">Section name</label>
              <div class="relative inline-block w-full rounded-md ">
                <button class=" z-0 w-full py-2 pl-3 pr-10 text-left text-gray-100 font-normal border border-purple-100 rounded-md cursor-default focus:outline-none focus:shadow-outline-blue focus:border-blue-300 sm:text-sm sm:leading-5" x-text="select.value" x-on:click="show = true">
              ...
              <input type="text"  class="w-full py-2 text-xs px-2 text-gray-100" placeholder="Add a new section" x-show="newSection">
            </div>
          </div>
              ...
              <div class="my-6">
                ...
                <div class="relative inline-block w-full rounded-md ">
                  <button class=" z-0 w-full py-2 pl-3 pr-10 text-left text-gray-100 font-normal border border-purple-100 rounded-md cursor-default focus:outline-none focus:shadow-outline-blue focus:border-blue-300 sm:text-sm sm:leading-5" x-text="selectCategory.value" x-on:click="showCategory = true">
                ...
                <input type="text"  class="w-full py-2 text-xs px-2 text-gray-100" placeholder="Add a new section" x-show="newCategory">
              </div>
            </div>
                  ...
                  <li @click.prevent="selectCategory = category; showCategory = false" class="relative py-2 pl-3  text-gray-200 cursor-default select-none pr-9" :class="{ ' text-blue-100 hover:bg-purple-100': showCategory == true}">
