...
<form action="{{route('storeSubject')}}" method="post" class="overflow-auto" style="background-color:rgba(190,192,201,0.7);" x-show="isCreateModalOpen" :class="{ 'absolute inset-0 z-10 flex items-center justify-center': isCreateModalOpen }">
    @csrf
