            ...
            <div class="flex flex-col mt-2">
                <div class="align-middle min-w-full overflow-x-auto  overflow-hidden ">
                    <table class="min-w-full divide-y  divide-purple-100">
                        ...
                        <template x-for="(content, index) in filteredCaFormatTable" :key="index">
                            ...
                            <tr class="bg-white">
                                ...
                                <td class="max-w-0  px-6 py-4 whitespace-nowrap text-xs text-gray-900">
                                    <div class="flex">
                                        <p class="group inline-flex space-x-2 truncate">
                                            <span class="text-gray-500 truncate" x-text="content.name"></span>
                                        </p>
                                    </div>
                                </td>

                                <td class="px-6 py-4 text-center whitespace-nowrap text-gray-200">
                                    <span @click="onClickClassModalOpen(content.uuid)" class="cursor-pointer text-xs text-gray-200 font-normal border-b pb-1 border-dashed border-green-100">
                                        view
                                    </span>
                                </td>

                                <td class="px-6 py-4 text-center whitespace-nowrap text-gray-200">
                                    <span @click="onClickOpenFormatModal(content.uuid)" class="cursor-pointer text-xs text-gray-200 font-normal border-b pb-1 border-dashed border-green-100">
                                        view
                                    </span>
                                </td>
                                ...
                                <td class="md:px-6 py-4 text-left whitespace-nowrap text-sm text-gray-200 flex items-center">
                                    <button class="focus:outline-none" x-on:click="editModal = true">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mt-2 text-blue-100 mx-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" >
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                                        </svg>
                                    </button>
                                    <button class="focus:outline-none">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mt-1.5 text-red-100" fill="none" viewBox="0 0 24 24" stroke="currentColor">
