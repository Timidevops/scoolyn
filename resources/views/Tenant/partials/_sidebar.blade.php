            ...
            <nav class="mt-8 flex-1 flex flex-col mx-auto overflow-y-auto" aria-label="Sidebar">
                <div class="px-2 space-y-1 ">
                   <div class="relative" x-data="{ show: false }" >
                    <a href="{{route('dashboard')}}" class="text-gray-300 flex items-center w-56 px-8 py-4 text-base  leading-6 font-medium rounded-md focus:outline-none focus:bg-blue-100 focus:text-white" x-on:click="show = !show">
                    ...
                    <div class="relative" x-data="{ show: false}">
                        <button  class="cursor-pointer flex focus:outline-none items-center w-56 px-8 py-4 text-base  font-medium leading-6 rounded-md  text-gray-300 focus:bg-blue-100 focus:text-white" x-on:click="show = !show">
                          ...
                          <ul class="" x-show="show">
                              ...
                              <li>
                                <a href="/parents" class=" flex items-center px-8 py-4 text-base leading-6 font-medium rounded-md text-gray-300 focus:bg-blue-100 focus:text-white">
                    ...
                    <div class="relative" x-data="{ show: false }">
                        <a href="http://app.scoolyn.com.test/results" class="cursor-pointer flex items-center w-56 px-8 py-4 text-base font-medium leading-6 rounded-md  text-gray-300 focus:bg-blue-100 focus:text-white" x-on:click="show = !show" >
                            <svg xmlns="http://www.w3.org/2000/svg" class="mr-4 h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" >
             ...
             <nav class="mt-8 flex-1 flex flex-col overflow-y-auto" aria-label="Sidebar">
                <div class="px-2 space-y-1 ">
                   <div class="relative" x-data="{ show: false }" >
                    ...
                    <div class="relative" x-data="{ show: false }">
                        <a href="http://app.scoolyn.com.test/subject#" class="cursor-pointer flex items-center w-56 px-8 py-4 text-base  font-medium leading-6 rounded-md  text-gray-300 focus:bg-blue-100 focus:text-white" x-on:click="show = !show">
                            <svg xmlns="http://www.w3.org/2000/svg" class="mr-4 h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="relative" x-data="{ show: false}">
                        <a href="http://app.scoolyn.com.test/classes#" class="cursor-pointer flex items-center w-56 px-8 py-4 text-base  font-medium leading-6 rounded-md  text-gray-300 focus:bg-blue-100 focus:text-white" x-on:click="show = !show">
                            <svg class="mr-4 h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                            </svg>
                           <span class="focus:text-white">Classes</span>
