              ...
              <tbody>
                <template x-for="(item, index) in filteredStudentTable" :key="index">
                    <tr class="bg-white divide-y divide-purple-100">
                        ...
                        <td class="max-w-0 px-6 py-4 whitespace-nowrap text-xs text-gray-900">
                            <div class="flex">
                                <p href="#" class="group inline-flex space-x-2 truncate">
                        ...
                        <td class="px-6 py-4 text-left whitespace-nowrap text-xs text-gray-200">
                            <span class="text-gray-200 font-normal" x-text="item.class_section.section_name"></span>
                            <p class="text-gray-200 font-bold text-xs" x-text="item.class_section_category ? item.class_section_category.category_name : ''"></p>
                        </td>
