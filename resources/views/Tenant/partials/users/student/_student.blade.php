<div>
    ...
    <span class="mt-2 text-base text-gray-300">4200 Total Subjects</span>
</div>
...
<div class="md:flex md:items-center md:mt-2 ">
  <div class="py-6 px-2 relative w-full">
   ...
   <a href="http://app.scoolyn.com.test/addStudent" class="bg-blue-100 text-white rounded-md py-3 mx-2 md:w-1/4   text-sm flex items-center" >
    <span class="mx-2">
