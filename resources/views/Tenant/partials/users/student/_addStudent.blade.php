...
<div class="bg-white rounded-md "  x-data="addStudent()">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 p-4">
        ...
        <div class="mt-2">
            <label for="Second name" class="block text-sm font-normal text-gray-100">Second name</label>
            <input type="text" name="" id="" class="w-full text-gray-100 rounded-md py-2 px-2 border border-purple-100 "></div>
        ...
        <div class="Birth Day">
            <label for="" class="block text-sm font-normal text-gray-100">Birth Day</label>
        ...
        <div class="mt-2">
            ...
            <div class="mt-2 relative">
                ...
                <div class="relative inline-block w-full rounded-md ">
                  ...
                  <div  class="border border-purple-100 absolute w-full bg-white">
                  <ul class="py-1 overflow-auto h-32 text-base leading-6
                   shadow-xs max-h-60 focus:outline-none sm:text-sm sm:leading-5" x-show="open">
            ...
            <div class="mt-2 relative">
                ...
                <div class="relative inline-block w-full rounded-md ">
                 ...
                 <p x-text="parent.value" class="inline-flex"></p>
                  </li>
                    </template>
                  </ul>
                  </div>
      ...
      <div class="px-4 py-4">
        <button type="button" href="" class="bg-blue-100 text-white rounded-md py-3 px-2  md:w-1/5 text-sm">
            Add student
        </button>
    </div>
</form>
