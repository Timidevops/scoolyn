            ...
            <div class="flex flex-col mt-2">
                <div class="align-middle min-w-full overflow-x-auto  overflow-hidden ">
                    <table class="min-w-full divide-y  divide-purple-100">
                        ...
                        <tbody>
                        <template x-for="(item, index) in filteredSchoolTable" :key="item"  class="bg-white divide-y divide-purple-100">
                            <tr class="bg-white">
                                ...
                                <td class="px-6 py-4 text-left whitespace-nowrap text-xs text-gray-200">
                                    <span class="text-gray-200 capitalize font-normal" x-text="item.name"></span>
                                </td>

                                <td class="px-6 py-4 text-left whitespace-nowrap text-xs text-gray-200">
                                    <span class="text-gray-200 font-normal" x-text="item.domain"></span>
                                </td>

                                <td class="px-4 py-4 text-left whitespace-nowrap text-sm text-gray-200 flex items-center">
