...
<div class="mx-2 md:w-1/4">
    <button wire:click="$set('isAddTeacherModalOpen', true)" type="button" class="bg-blue-100 text-white rounded-md py-3 text-sm flex items-center" >
    <span class="mx-2">
      <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z" />
      </svg>
    </span>
        <span class="mx-2">Add Class Teacher</span>
    </button>

    <form wire:submit.prevent="store" class="overflow-auto @if($isAddTeacherModalOpen) absolute inset-0 z-10 flex items-center justify-center @else hidden @endif" style="background-color:rgba(190,192,201,0.7);">
        @csrf
        <div class="mt-12 sm:mx-auto sm:w-full sm:max-w-md md:max-w-md  bg-white rounded-lg shadow-md">
            <div class="flex items-center justify-between mt-3 text-gray-200 text-base mx-4 ">
              ...
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 12H4" />
                ...
                <button type="button" wire:click="$set('isAddTeacherModalOpen', false)" class="focus:outline-none">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
