            ...
            <div class="flex flex-col mt-2">
                <div class="align-middle min-w-full overflow-x-auto  overflow-hidden ">
                    ...
                    <img src="{{asset('images/filter_alt_black_24dp.svg')}}" alt="" class="w-4">
                        ...
                        <template x-for="(content, index) in academicSessionTable" :key="index">
                            <tr class="bg-white">
                                ...
                                <td class="max-w-0  px-6 py-4 whitespace-nowrap text-xs text-gray-900">
                                    <div class="flex">
                                        <p class="group inline-flex space-x-2 truncate">
                                            <span class="text-gray-500 truncate capitalize" x-text="content.session_name"></span>
                                        </p>
                                    </div>
                                </td>

                                <td class="px-6 py-4 text-left capitalize whitespace-nowrap text-xs text-gray-200">
                                    <span class="text-gray-200 font-normal" x-text="content.get_term.name"></span> term
                                </td>
