          ...
          <div class="align-middle min-w-full overflow-x-auto  overflow-hidden ">
            <table class="min-w-full divide-y  divide-purple-100">
              ...
              <tr>
               ...
               <tbody>
               <template x-for="(item, index) in filteredParentTable" :key="item"  class="bg-white divide-y divide-purple-100">
                   <tr class="bg-white">
                       ...
                       <td class="px-6 py-4 text-left whitespace-nowrap text-xs text-gray-200">
                    <span class="text-gray-200 font-normal" x-text="item.email">
                    </span>
                       </td>

                       <td class="px-4 py-4 text-left whitespace-nowrap text-sm text-gray-200 flex space-x-2 items-center">
                           ...
                           <a :href="`{{route('listParentWard','')}}/${item.uuid}`">
                               <button type="submit" class="focus:outline-none ">
                                   Wards
                               </button>
                           </a>
