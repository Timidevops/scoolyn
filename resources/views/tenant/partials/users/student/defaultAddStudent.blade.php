        ...
        <form x-data="add()">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 p-4">
                <div class="mt-2">
                    ...
                    <input type="text" name="" id="" class="w-full text-gray-100 rounded-md py-2 px-2 border border-purple-100" required x-model='name' >
                </div>
                ...
                <div class="mt-2">
                    <label for="text" class="block text-sm font-normal text-gray-100">Other Names</label>
                    <input type="text" name="" id="" class="w-full text-gray-100 rounded-md py-2 px-2 border border-purple-100" required>
                </div>
