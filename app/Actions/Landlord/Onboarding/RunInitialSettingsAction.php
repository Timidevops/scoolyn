        ...
        Setting::query()->create([
            ...
            'meta' =>  [
                [
                    ...
                    'done' => 0,
                    'description' => 'Go to settings to set academic calendar',
                    'url' => 'academicSession',
                ],
                [
                ...
                [
                    ...
                    'done' => 0,
                    'description' => 'Go to subject to add subject',
                    'url' => 'listSubject',
                ],
                [
                ...
                [
                    ...
                    'done' => 0,
                    'description' => 'Go to Results / Academic grading format to add grading format',
                ...
                [
                    ...
                    'done' => 0,
                    'description' => 'Go to settings / School details to set school logo',
                    'url' => 'schoolDetailsSettings',
                ],
                [
                    'name' => OnboardingTodoList::SET_SCHOOL_DETAIL_PRINCIPAL,
                    'done' => 0,
                    'description' => 'Go to settings / School details to set school principal',
                    'url' => 'schoolDetailsSettings',
                ],
            ],
        ]);
